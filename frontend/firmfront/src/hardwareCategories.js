...
const hardwareCategories = [
  {
    ...
    components: [
        { id: 1, name: 'Arduino Uno', pin: 'A0-A5, D0-D13', img: {src:require("./assets/arduinoUno.png"),height: 400} },
  ...
  },
  {
    category: 'Sensors',
    components: [
        { id: 5, name: 'PIR Sensor', pin: 'VCC, Signal, GND', img: {src:require("./assets/PIRSensor.png"), height:100} },
  ...
  },
  {
    category: 'Basic',
    components: [
        { id: 9, name: 'LED', pin: 'VCC, GND', img: {src:require("./assets/LED.png"), height: 50} },
